            ...
            <main style={{ textAlign: "center" }}>
                ...
                <form className="form--login" onSubmit={nextPage}>
                    ...
                    <fieldset>
                        ...
                        <input onChange={handleInputChange} type="text" name="firstName" className="form-control" placeholder="first name" value={registerUser.firstName} id="firstName" required autoFocus />
                    </fieldset>
                    <fieldset>
            ...
            <main style={{ textAlign: "center" }}>
                ...
                <form className="form--login" onSubmit={handleRegister}>
                    ...
                    <fieldset>
                        ...
                        <input onChange={handleInputChange} value={registerUser.locationId} type="email" name="email" className="form-control" placeholder="9805554466" required />
                    </fieldset>
                    <fieldset>
                        <label htmlFor="inputEmail"> Address </label>
                        <input onChange={handleInputChange} value={registerUser.locationId} type="email" name="email" className="form-control" placeholder="address" required />
                    </fieldset>
                    <fieldset>
                        <label htmlFor="inputEmail"> City </label>
                        <input onChange={handleInputChange} value={registerUser.locationId} type="email" name="email" className="form-control" placeholder="city" required />
                    </fieldset>
                    <fieldset>
